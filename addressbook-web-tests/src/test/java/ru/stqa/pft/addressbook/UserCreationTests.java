...
public class UserCreationTests {
  ...
  @Test
  public void testUserCreationTests() {
    gotoNewPerson();
    fillNewPerson(new PersonData("fAlex", "fSerg", "fPanchenko", "fprevedko", "mr", "aplana", "t89137899903@gmail.com"));
    submitNewPerson();
  }
  ...
  private void fillNewPerson(PersonData personData) {
    wd.findElement(By.name("firstname")).click();
    wd.findElement(By.name("firstname")).clear();
    wd.findElement(By.name("firstname")).sendKeys(personData.getFirst_name());
    wd.findElement(By.name("middlename")).click();
    wd.findElement(By.name("middlename")).clear();
    wd.findElement(By.name("middlename")).sendKeys(personData.getMiddle_name());
